 ...
 * @buf: address of buffer pointer
 * @len: address of len var pointer
 * Return: bytes read
 */
 ...
 * @length: size of preallocated ptr buffer if not NULL, pointer
 * Return: s
 */
 ...
 * @sig_num: points to the signal number
 * Return: void
 */
